...
<head>
  ...
  <link rel="stylesheet" href="stylecpw.css">
</head>
...
<body>
  ...
  <form action = "" method = "post">
    <div>
      <img class="background" src="assets/backgroundklp.png" height="400" width="670">
      <div class="section-daftar">
        <div class="login-text">Permintaan Anda telah dikirim</div>
        <div class="welcome">Silahkan periksa SMS Anda yang telah Kami kirim.</div>
      </div>    
    </div>
  </form>
